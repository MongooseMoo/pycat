    ...
    def iac(self, sock, cmd, option):
        if cmd == telnetlib.WILL:
            if option == telnetlib.GMCP:
                ...
                supportables = [
                    'char 1', 'char.base 1', 'char.maxstats 1', 'char.status 1', 'char.statusvars 1', 'char.vitals 1', 'char.worth 1','char.items 1',
                    'comm 1', 'comm.channel 1', 'comm.tick 1',
                    'group 1', 'room 1', 'room.info 1'
                ]
